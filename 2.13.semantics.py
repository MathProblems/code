...
class entity:
    ...
    def __init__(self,num="",ent="",deps=None,s=None):
        self.num = num
        self.ent = ent
        self.adj = ""
        self.verb = ""
...
def training(trips,problem):
    ...
    for op,a,b in trips:
        ...
        for k in a.__dict__:
            #print(k)
            if k in ["sent","ow","orels",'text']:continue
...
if __name__ == "__main__":
    ...
    for j in range(len(wps)):
        ...
        lastsent = problem.split(". ")[-1]
        tmpexamples = training(trips,lastsent)
        for k in texamples:
    ...
    f2 = open("data/2.19_2.asmdexamples_allfeatures",'wb')
